      ...
      onRequest: (
        ...
        return {
          promise: (async () => {
            ...
            const SIGN_STR = `Hi! Welcome to cccc. Please sign the message to let us know that you own the wallet. Signing is gas-less and will not give Dexx permission to conduct any transactions with your wallet. Timestamp is ${timestamp}.`;
