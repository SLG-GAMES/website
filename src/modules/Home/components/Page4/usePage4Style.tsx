...
import logo from 'assets/img/page4/logo1.gif'
import h5_logo from 'assets/img/page4/logo1.gif'

export const usePage4Style = makeStyles((theme: Theme) => ({
  root: {
		width: '100%',
		height: '100%',
    ...
    '& .logo': {
      ...
      [theme.breakpoints.down('sm')]: {
        ...
        height: '32.7907rem',
        marginTop: '2.9rem',
        background: `url(${h5_logo}) no-repeat`,
